...
def go(args):
    '''
    Train pipeline, score metrics and upload
    '''
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # a step called "preprocessor" applying the ColumnTransformer 
    # instance that we saved in the `preprocessor` variable, and 
    # a step called "random_forest" with the random forest instance 
